...
void setup() {
 ...
 // setup transmit queue ******************************************************
  ...
  button_array[1][2][1][1] = 10;    // zoom -
  button_array[2][2][1][1] = 11;    // zoom +
  button_array[5][2][1][1] = 22;    // req dock
  button_array[7][2][1][1] = 23;    // pitch up
  button_array[0][2][2][1] = 27;    // cancel jump
  button_array[1][2][2][1] = 26;    // confirm jump
  button_array[2][2][2][1] = 25;    // initiate jump
  button_array[4][2][2][1] = 29;    // emergency jump reverse
  button_array[5][2][2][1] = 28;    // emergency jump forward
  button_array[7][2][2][1] = 24;    // pitch down
  button_array[1][0][1][1] = 20;    // shields up
  button_array[3][0][1][1] = 21;    // shields down
  button_array[0][0][2][1] = 12;    // view forward
  button_array[1][0][2][1] = 14;    // view right
  button_array[2][0][2][1] = 19;    // view "CAM"
  button_array[3][0][2][1] = 13;    // view left
  button_array[4][0][2][1] = 15;    // view aft
  button_array[5][0][2][1] = 18;    // view INFO
  button_array[6][0][2][1] = 17;    // view LRS
  button_array[7][0][2][1] = 16;    // view TAC

  // complex "high-level" commands second
  button_array[0][2][1][1] = 120;   // request adjust impulse power level
  button_array[3][2][1][1] = 121;   // toggle warp system mode
  button_array[4][2][1][1] = 122;   // request adjust warp power level
  button_array[6][2][1][1] = 123;   // request adjust manuever power level
  button_array[3][2][2][1] = 124;   // enter jump course
...
void set_slider (int pos, int state) {
  ...
  switch (pos) {
    case 0:   // impulse slider -- click on speed bar; toggle reverse if under threshold value
        ...
        light_array[3][0][2] = false;
        light_array[4][0][2] = false;
        light_array[5][0][2] = false;
        light_array[6][0][2] = false;
        light_array[7][0][2] = false;
      if (state > SLIDER_N1) {
