// Artemis SBS Engineering Control Panel (Block III) Code
...
bool connected_panels[4] = {true, true, false, false};
...
void setup() {
  ...
  button_array[0][0][1][1] = 92;    // coolant 1 up
  button_array[1][0][1][1] = 93;    // coolant 2 up
  button_array[2][0][1][1] = 94;    // coolant 3 up
  button_array[3][0][1][1] = 95;    // coolant 4 up
  button_array[4][0][1][1] = 96;    // coolant 5 up
  button_array[5][0][1][1] = 97;    // coolant 6 up
  button_array[6][0][1][1] = 98;    // coolant 7 up
  button_array[7][0][1][1] = 99;    // coolant 8 up
  button_array[0][0][2][1] = 100;    // coolant 1 dn
  button_array[1][0][2][1] = 101;    // coolant 2 dn
  button_array[2][0][2][1] = 102;    // coolant 3 dn
  button_array[3][0][2][1] = 103;    // coolant 4 dn
  button_array[4][0][2][1] = 104;    // coolant 5 dn
  button_array[5][0][2][1] = 105;    // coolant 6 dn
  button_array[6][0][2][1] = 106;    // coolant 7 dn
  button_array[7][0][2][1] = 107;    // coolant 8 dn

  button_array[0][1][1][1] = 70;    // preset 0
  button_array[1][1][1][1] = 71;    // preset 1
  button_array[2][1][1][1] = 72;    // preset 2
  button_array[3][1][1][1] = 73;    // preset 3
  button_array[4][1][1][1] = 74;    // preset 4  
  button_array[0][1][2][1] = 75;    // preset 5
  button_array[1][1][2][1] = 76;    // preset 6
  button_array[2][1][2][1] = 77;    // preset 7
  button_array[3][1][2][1] = 78;    // preset 8
  button_array[4][1][2][1] = 79;    // preset 9
  button_array[5][1][2][1] = 90;    // reset power
  button_array[6][1][2][1] = 91;    // reset coolant
  
  // complex "high-level" commands second
  button_array[5][1][1][1] = 160;    // str/rcl
    ...
    switch (command_queue[current_command][0]) {
      ...
      case 160:
        if (!store_on) {
          ...
          light_array[4][2][1] = false; 
        }
        else {
          store_on = false;
          light_array[3][2][1] = false;
          light_array[4][2][1] = true; 
        }
      break;
...
void read_analog() {
  ...
  if (slider_reads == 3) {
    ...
    slider_reads = 0;
    Serial.print(slider_state[0][0]);
    Serial.print(" ");
    Serial.print(slider_state[0][1]);
    Serial.print(" ");
    Serial.print(slider_state[0][2]);
    Serial.print(" ");
    Serial.print(slider_state[0][3]);
    Serial.print(" ");
    Serial.print(slider_state[0][4]);
    Serial.print(" ");
    Serial.print(slider_state[0][5]);
    Serial.print(" ");
    Serial.print(slider_state[0][6]);
    Serial.print(" ");
    Serial.println(slider_state[0][7]);
  }
}
...
void refresh_lights() {
  ...
  for (int i=0; i<8; i++) {
    light_array[i][6][0] = system_status_light_on[i];
  }
  ...
  switch (code) {
    ...
    case 120: // transmit power settings
      ...
      for (int i=0; i<8; i++) {
        ...
        RS_485_TX[dmx_transmit_queue_last][i+2] = byte (pwr);
      }
    break;
  }
